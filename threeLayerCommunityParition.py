...
'''
This script finds the community structure of a 3-layer graph.
'''
...
def plot_graph_stack(G,broken_graph,broken_partition,npartition,layer1,layer2,layer3,d1=1.5,d2=5.,d3=0,d4=.8,nodesize=1000,withlabels=True,edgelist=[],layout=True,alpha=0.5):
    ...
    title_s='%i communities (%i 3-layered, 2-layered, %i 1-layered)' %(len(npartition),len(npartition)-singles,singles)
...
# plot_graph(G,broken_graph,broken_partition,npartition,layer1,layer2,layer3,withlabels=False,nodesize=200,layout=False)
